...
(function () {
    setlayout();
    $("body").off("click", "a[title=选择图片]");
    $("body").on("click", "a[title=选择图片]", function (i, n) {
        var $ele = this;
        oa.people.uploadFile({
            ok: function (files) {
                ckImageSelected(files);
            }
        })
    });
                ...
                id: "info", label: d.lang.image.infoTab, accessKey: "I", elements: [{
                    type: "vbox", padding: 0, children: [{
                        type: "hbox", widths: ["280px", "110px"], align: "right", className: "cke_dialog_image_url", children: [{
                            ...
                            type: "button", id: "btn_ckedit_upload", style: "display:inline-block;margin-top:14px;",
                            align: "center", label: "选择图片", hidden: !1, filebrowser: "info:txtUrl"
                        }]
                    }]
